...
const HeroSection = ({ children }: HeroSectionProps) => {
  return (
    <section className="relative flex flex-col justify-end overflow-hidden pt-12 md:pt-16 pb-8 md:pb-10 min-h-[75vh] md:min-h-[85vh] lg:min-h-[90vh] bg-slate-950">
      {/* Background: fachada enfocada en el letrero principal, marcas y entrada de la tienda */}
      <img
        src="/FachadaRS.png"
